...
##Data Cleaning
1. remove NA, blank cells,N/A
2. check if there's duplicate publisher name in Top 10 publishers
3. merge those duplicate data into one publisher name
...
index_interactive <- grep(pattern = "take-two", x = GameSales$publisher)
...
## By region - check NA, EU, JP markets, which Genre has more sales 
```{r }
